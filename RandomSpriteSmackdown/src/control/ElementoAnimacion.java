...
public class ElementoAnimacion {
	...
	public  ArrayList<ElementoAnimacion> CrearAnimSaltando(Personaje p) {
			if(p.getTipoPersonaje().equals("robot")) {
				...
				animSaltando.add(new ElementoAnimacion("pngEnem/Jump__001.png", 200));
				animSaltando.add(new ElementoAnimacion("pngEnem/Jump__002.png", 300));
				animSaltando.add(new ElementoAnimacion("pngEnem/Jump__003.png", 400));
				animSaltando.add(new ElementoAnimacion("pngEnem/Jump__004.png", 500));
				animSaltando.add(new ElementoAnimacion("pngEnem/Jump__005.png", 600));
				animSaltando.add(new ElementoAnimacion("pngEnem/Jump__006.png", 700));
				animSaltando.add(new ElementoAnimacion("pngEnem/Jump__007.png", 800));
	...
	public long getTiempoAnimParado() {
		return animParado.get(animParado.size()- 1).tiempos;
	}
	public  long getTiempoAnimSaltando() {
		return animSaltando.get(animSaltando.size()- 1).tiempos;
	...
	public long getTiempoAnimGolpeado() {
		return animGolpeado.get(animGolpeado.size()- 1).tiempos;
	}
}
